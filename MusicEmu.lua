...
function MusicEmu:setVolume(v)
	self.source:setVolume(v)
end

function MusicEmu:fade()
...
function newMusicEmu(filename, buffersamples, rate)
	...
	lib.gme_open_data(data:getPointer(), data:getSize(), musicemu,
				self.rate)
